...
<div class="dg-card p-3 mb-4">
    <form action="{{ route('admin.answers.index') }}" method="GET" class="row g-2 align-items-center dg-realtime-search-form">
        <div class="col-md-8">
            <div class="input-group">
                <span class="input-group-text bg-transparent border-end-0 text-muted"><i class="bi bi-search"></i></span>
                <input type="text" name="q" class="form-control form-control-dg border-start-0 ps-0 dg-realtime-input" placeholder="Search answer text..." value="{{ $search }}" autocomplete="off">
            </div>
        </div>
        <div class="col-md-4">
